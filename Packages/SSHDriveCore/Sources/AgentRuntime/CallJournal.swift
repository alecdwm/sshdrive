...
public final class CallJournal: @unchecked Sendable {
    ...
    public func snapshot(domain: String?, limit: Int) -> [Entry] {
        lock.lock()
        defer { lock.unlock() }
    ...
    public func report(domain: String?, limit: Int) -> [String: Any] {
...
/// the arrival time.
public final class CallTiming: @unchecked Sendable {
    ...
    public init(domain: String, method: String, subject: String) {
        self.domain = domain
        self.method = method
