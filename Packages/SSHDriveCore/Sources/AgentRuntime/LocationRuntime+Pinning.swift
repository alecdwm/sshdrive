...
extension LocationRuntime {
    ...
    public func applyPin(pathString: String, request: PinPolicy.Request) async throws -> [String: Any] {
    ...
    public func pinnedSubtreeDirectories() throws -> [Data] {
        let markers = try pinMarkers()
    ...
    public func excludedSweepPaths() throws -> [String] {
    ...
    @discardableResult
    public func reassertKeptItems(materializedIdentifiers: [String]?) throws -> [String] {
    ...
    public func evictionRows(identifiers: [String]) throws -> [EvictionPlan.Candidate] {
    ...
    /// eviction succeeded.
    public func noteEvicted(identifiers: [String]) throws {
        try index.batch {
            for identifier in identifiers {
