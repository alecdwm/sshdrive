...
/// connection (docs/design/extension.md).
@objc public protocol SSHDriveExtensionProtocol {
    ...
    /// The agent is about to truncate and rebuild the index (docs/design/item-index.md). The
    /// reader holds the -shm file mapped, so it must close before the truncate; until
